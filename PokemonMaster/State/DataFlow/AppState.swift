...
extension AppState {
    struct PokemonList {
        ...
        func displayPokeemon(with settings: Settings) -> [PokemonViewModel] {
            ...
            func containsSerachText(_ pokemon: PokemonViewModel) -> Bool {
            ...
            filterFuncs.append(containsSerachText)
            ...
            return pokemons.values.filter(filterFunc).sorted(by: sortFunc)
        }
    }
